...
def main(
    ...
    ## Get Data
    out_dir = os.path.join(f'./data/self_similarity/{track_name}/')
    ...
    all_groups = [group] # all_segments_reduced
    
    ## START GROUPING

    #   print('Identifying Segment Groups')
    #   all_groups = group_segments(all_segments_reduced, min_length_cqt, match_tol, silence_and_stable_mask, cqt_window, timestep, sr, raw_pitch)
    ...
    #   all_groups_over = group_overlapping(all_groups_ext, dupl_perc_overlap_inter, group_len_var)
