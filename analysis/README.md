...
This code was developed with Python 3.7.0. 

Please install requirements if you wish to run the following scripts.
...
### 1. Data
It is necessary to download two datasets to use this code, one corresponding to the performance audios and one corresponding to the motion capture data (MOCAP) of the performers movement during performance. Both can be found [here](https://osf.io/6huvd/). 
...
The best parameters for each model can be found in `parameters/`

`parameters/pred_sonic_all.csv` - Predicting sonic features with all kinematic features

`parameters/pred_sonic_head.csv` - Predicting sonic features with head kinematic features

`parameters/pred_sonic_hand.csv` - Predicting sonic features with hand kinematic features
